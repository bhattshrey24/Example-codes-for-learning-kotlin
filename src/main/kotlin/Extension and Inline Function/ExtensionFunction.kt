...
class ExtensionFunction {
    ...
    fun String.myFormatString(): String { // we can extend primitive classes that are given to us by Kotlin
        return "$this-----This is Your Formatted String" // here 'this' basically refers to the string on which we call this method
    }
    ...
    fun MutableList<String>.swap2Variable(
        ...
        val temp = this[index1]// here 'this' refers to the mutableList on which we called this function
        this[index1] = this[index2]
        this[index2] = temp
    }

    fun Emp.showEmployeeDetails(): String {// And we can also extend our own classes , observe we are doing it outside the class
    ...
    var Emp.age: Int // This is an extension property , we can't initialize them and we have to add a getter and a setter with them
        get() = 0
